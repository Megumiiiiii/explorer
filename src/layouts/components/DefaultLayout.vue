    ...
    >
      <div class="flex justify-between mt-1 pl-4 py-4 mb-1">
        <RouterLink to="/" class="flex items-center">
          <img class="w-10 h-10" src="../../assets/ksk.png" />
      ...
      <div class="px-2">
          ...
          >
            <Icon icon="mdi:controller-classic" class="text-xl text-red-400 mr-2" />
            <div
      ...
      <!--
        ...
        <a
          ...
          class="py-2 px-4 flex items-center cursor-pointer rounded-lg hover:bg-gray-100 dark:hover:bg-[#373f59]"
        >
          <Icon icon="mdi:twitter" class="text-xl text-cyan-500 mr-2" />
          <div
            class="text-base capitalize flex-1 text-gray-600 dark:text-gray-200"
          >
            X
       ...
       -->
        ...
        >
          <Icon icon="mdi:google-downasaur" class="text-xl text-green-300 mr-2" />
          <div
            class="text-base capitalize flex-1 text-gray-600 dark:text-gray-200"
          >
            Website
